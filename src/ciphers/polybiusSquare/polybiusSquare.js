...
export function run(args) {
  ...
  // Si estamos decodificando necesitamos cada par de números.
  const increment = isEncoding ? 1 : 2;
  utils.forEachCharacter(inputStr, increment, (i, char) => {
    if (isEncoding) {
      // Busca el carácter  en el arreglo alfanumérico, y en base
      // a esa posición calcula X y Y coordinadas en la tabla
